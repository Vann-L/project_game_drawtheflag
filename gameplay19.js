class gameplayScene19 extends Phaser.Scene {
    constructor() {
        super('gameplay19');
    }
    ...
    preload() {
        ...
        // PALET JERMAN: Hitam, Merah, Kuning (Pake aset yang udah ada)
        ...
        // ASET BENDERA MENANG
        this.load.image('flagwin_lvl19', 'asset/flagwin_lvl19.png');
    ...
    create() {
        ...
        // Definisi Warna Jerman
        this.colorBlack = 0x000000;
        this.colorRed = 0xDD0000;
        this.colorYellow = 0xFFCE00;

        // JAWABAN BENAR JERMAN (Hitam - Merah - Kuning)
        this.flagAnswers = [
            { text:"HITAM DI BAGIAN ATAS", top: this.colorBlack },
            { text:"MERAH DI BAGIAN TENGAH", mid: this.colorRed },
            { text:"KUNING DI BAGIAN BAWAH", bottom: this.colorYellow } 
        ];
        ...
        // BANK SOAL JERMAN
        this.hintQuestions = [
            {q:"Apa ibu kota negara Jerman?",a:"München",b:"Berlin",c:"Frankfurt",d:"Hamburg",correct:"b"},
            {q:"Jerman sangat terkenal dengan industri apa?",a:"Pakaian & Sepatu",b:"Elektronik & HP",c:"Otomotif (Mobil)",d:"Pertanian",correct:"c"},
            {q:"Jerman terletak di benua apa?",a:"Asia",b:"Eropa",c:"Amerika",d:"Australia",correct:"b"},
            {q:"Makanan berupa sosis khas Jerman disebut?",a:"Bratwurst",b:"Hotdog",c:"Kebab",d:"Burger",correct:"a"},
            {q:"Tembok bersejarah yang dulu membelah ibu kota Jerman bernama?",a:"Tembok Besar",b:"Tembok Berlin",c:"Tembok Ratapan",d:"Tembok Merah",correct:"b"}
        ];
        ...
        // RUMUS JERMAN: Dibagi 3 horizontal rata
        ...
        // ================= PENYUSUNAN LAYER BENDERA JERMAN ================= //
        ...
        // LOGIKA MEWARNAI (Dari Kiri ke Kanan karena garisnya mendatar)
        ...
        // PALET WARNA JERMAN (Hitam, Merah, Kuning)
        ...
        const pMerah = this.add.image(width - 90, height/1.75, 'paletMerah').setInteractive().setScale(0.8);
        ...
        this.add.text(titleX, titleY, 'JERMAN', { fontSize: (32 * titleScale) + 'px', fontFamily: 'Arial', color: '#000000', fontStyle: 'bold' }).setOrigin(0.5);
    ...
    checkWinCondition(zoneTop, zoneMid, zoneBottom) {
        ...
        // JERMAN: Hitam (Atas), Merah (Tengah), Kuning (Bawah)
        if (zoneTop.getData('colorCode') === this.colorBlack && zoneMid.getData('colorCode') === this.colorRed && zoneBottom.getData('colorCode') === this.colorYellow) {
            this.gameOver = true; 
    ...
    showWinScreen() {
        ...
        let rewardLevel19 = localStorage.getItem('rewardLevel19');
        if(!rewardLevel19){
            let hintData = localStorage.getItem('hintData');
            let hint = hintData ? parseInt(hintData) : 0;
            hint += 1;
            localStorage.setItem('hintData', hint);
            localStorage.setItem('rewardLevel19', true);
        }
        ...
        const flag = this.add.image(flagX, flagY, 'flagwin_lvl19').setDepth(201).setScale(flagScale * 0.8).setAlpha(0);
        ...
        const unlockNextLevel = () => {
            ...
            levelData[19] = 2; 
            if (levelData[20] !== 2) levelData[20] = 1; 
        ...
        next.on('pointerdown', () => { unlockNextLevel(); this.scene.start('gameplay20'); }); // Lanjut Level 20
    }
