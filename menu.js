class menuScene extends Phaser.Scene {
  ...
  create() {
    ...
    // 🔥 BACA STATUS AUDIO DARI MEMORI BROWSER
    let isMusicOn = localStorage.getItem('music_on') !== 'false'; // Default nyala
    ...
    // === 3. SETUP UI VISUAL NOVEL & TUTORIAL ===
    ...
    // === 4. POPUP KONFIRMASI (SKIP TUTORIAL) ===
    ...
    // ==========================================================
    // === 5. UI PENGATURAN (SETTINGS) ==========================
    // ==========================================================

    // Tombol Gear Pengaturan
    this.settingBtn = this.add.image(width - 60, 60, 'btn_pengaturan')
        .setScale(0.8) 
        .setDepth(50)
        .setInteractive({ useHandCursor: true });

    // Efek visual tombol gear (membesar kecil saat dihover)
    ...
    this.btnSfxOn.on('pointerdown', () => {
        ...
        this.playMenuSFX('sfx_pop'); // Bunyi saat diaktifkan
    });

    this.btnSfxOff.on('pointerdown', () => {
        this.playMenuSFX('sfx_pop'); // Bunyi terakhir sebelum mati
    ...
    // Efek Hover Tombol Skip & Konfirmasi
  ...
  startIntro() {
    ...
    this.settingBtn.setVisible(false); // Sembunyikan gear saat intro
